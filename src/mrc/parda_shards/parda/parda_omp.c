...
processor_info_t
parda_get_thread_info(long lines, long begin, int pid, int psize)
{
...
void
parda_omp_openfile(char inputFileName[],
                   const int pid,
                   const int nthreads,
                   const int psize,
                   FILE *fpa[])
...
program_data_t
parda_omp_input_with_filename(char inputFileName[],
                              program_data_t *pdt_a,
                              long begin,
                              long end,
                              int pid,
...
program_data_t
parda_omp_input(char inputFileName[],
                program_data_t *pdt_a,
                long begin,
                long end,
                int pid,
...
void
parda_omp_free(program_data_t *pdt_a, int psize)
{
    int i;
...
void
parda_omp_stackdist(char *inputFileName, long lines, int threads)
{
#ifdef enable_timing
