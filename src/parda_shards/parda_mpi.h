...
narray_t *
parda_recv_array(int source, int *tag, unsigned element_size);
void
parda_send_array(narray_t *ga, int dest, int *tag);
unsigned *
parda_mpi_merge(program_data_t *pdt, processor_info_t *pit);
void
parda_mpi_free(program_data_t *pdt, unsigned *global_his);
int
