...
//     // Python script:
//     // import random; x = [random.randint(0, 10) for _ in range(100)];
//     print(x) EntryType entries[100] = {
...
//     struct FixedSizeShardsReuseStack me = {0};
//     // The maximum trace length is obviously the number of possible unique
//     items ASSERT_TRUE_WITHOUT_CLEANUP(
...
//     }
//     ASSERT_TRUE_OR_CLEANUP(
//         basic_histogram__exactly_equal(&me.histogram,
//         &basic_histogram_oracle), fixed_size_shards__destroy(&me));
//     fixed_size_shards__destroy(&me);
//     return true;
// }
